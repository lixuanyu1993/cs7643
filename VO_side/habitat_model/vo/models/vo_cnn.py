...
from habitat_model.model_utils.running_mean_and_var import RunningMeanAndVar
...
class ResNetEncoder(nn.Module):
    ...
    def forward(self, observation_pairs):
        ...
        cnn_input = []
        for i in range(len(self.tag_names)):
            self.input_appender(cnn_input, observation_pairs, self.tags[i], self.tag_names[i])
