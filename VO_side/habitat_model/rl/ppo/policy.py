...
from habitat_model.rl.models.simple_cnn import SimpleCNN
from habitat_model.utils.common import CategoricalNet, GaussianNet
...
class Policy(nn.Module, metaclass=abc.ABCMeta):
    def __init__(self, net, dim_actions, policy_config=None):
        ...
        # map state encoder rnn res (512) to action space size as probility
